...
namespace TourBooking.Application.Features.Mobile.Commands
{
    public class VerifyPhoneCommandHandler : IRequestHandler<VerifyPhoneCommand, VerifyPhoneCommandResponse>
    {
        private readonly UserManager<AppUser> _userManager;
        private readonly IEmailVerificationCodeRepository _repository;
        private readonly IStringLocalizer<SharedResource> _localizer;

        public VerifyPhoneCommandHandler(UserManager<AppUser> userManager, IEmailVerificationCodeRepository repository, IStringLocalizer<SharedResource> localizer)
        {
        ...
        public async Task<VerifyPhoneCommandResponse> Handle(VerifyPhoneCommand request, CancellationToken cancellationToken)
        {
            ...
            return new VerifyPhoneCommandResponse { Message = "" };
        }
    }
}