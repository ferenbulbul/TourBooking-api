...
{
    public class PaymentCallbackHandler : IRequestHandler<PaymentCallbackCommand,PaymentCallbackCommandResponse>
{
    private readonly IPaymentService _paymentService;
    private readonly IUnitOfWork _unitOfWork;

    public PaymentCallbackHandler(IPaymentService paymentService, IUnitOfWork unitOfWork)
    {
