...
namespace TourBooking.Infrastructure.Migrations
{
    ...
    [Migration("20251003232441_BookingTableDropGuide")]
    partial class BookingTableDropGuide
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TourBooking.Domain.Entities.BookingEntity", b =>
                {
                    ...
                    b.Property<Guid>("TourRoutePriceId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TourBooking.Domain.Entities.PaymentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("CfRawResponse")
                        .HasColumnType("longtext");
                    ...
                    b.Property<string>("RetrieveRawResponse")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("TourBooking.Domain.Entities.BookingEntity", b =>
                {
                    ...
                    b.HasOne("TourBooking.Domain.Entities.TourRoutePriceEntity", "TourRoutePrice")
                        .WithMany("Bookings")
                        .HasForeignKey("TourRoutePriceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Customer");

                    b.Navigation("GuideTourPrice");

                    b.Navigation("TourRoutePrice");
                });
            ...
            modelBuilder.Entity("TourBooking.Domain.Entities.PaymentEntity", b =>
                {
                    b.HasOne("TourBooking.Domain.Entities.BookingEntity", "Booking")
                        .WithMany("Payments")
